  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'button': '0 2px 10px 0 rgba(79, 209, 197, 0.2)',
        'button-hover': '0 4px 20px 0 rgba(79, 209, 197, 0.25)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'hero-glow': 'radial-gradient(circle at 50% 50%, rgba(79, 209, 197, 0.15), transparent 60%)',
